  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      <section className="relative overflow-hidden text-center">
        <HeroGraphic />
        <h1 className="font-display text-4xl font-bold italic tracking-tight text-brand-900 sm:text-5xl">
          {SITE_TAGLINE}
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-brand-700">
          No 150-person guest list, no six-figure budget — real planning
          guides for small, intentional weddings and elopements.
        </p>
        <Link
          href="/blog"
